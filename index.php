...
<html lang="pt-br">
	...
	<body>
		...
		<div class="wrapper">
			...
			<img src="images/banner-home.jpg" alt="Communica Plum">
			</div>
			<!-- //Banner -->
			<section class="sub-banner">
				<h2>Porque e importante gerenciar a sua marca?</h2>
				<p>Construir uma marca grande, forte e desejada, é hoje o desafio da maioria das empresas. Mas para isso, é preciso gerenciar experiências, expectativas e promessas que uma marca entrega as pessoas. </p>

				<p>Criar uma imagem forte e consistente em todos os mercados onde atua, requer alinhar estratégias de diferenciação com ideias inovadoras.
					E é isso o que a Gestão de Marcas, conhecida também como Branding, faz!
